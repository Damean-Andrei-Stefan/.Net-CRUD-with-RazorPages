...
namespace Damean_Andrei_Stefan_Lab2.Data
{
    public class Damean_Andrei_Stefan_Lab2Context : DbContext
    {
        ...
        public DbSet<Damean_Andrei_Stefan_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Damean_Andrei_Stefan_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
        public DbSet<Damean_Andrei_Stefan_Lab2.Models.Member> Member { get; set; } = default!;
    }
}
